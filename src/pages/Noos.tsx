...
function GridBackground({ language }: { language: string }) {
  return (
    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-[#E09502]">
      {/* Grid pattern */}
      <div 
      ...
      <div className="absolute inset-0 flex items-center justify-center flex-col pointer-events-none">
        <h1 
          className="text-[12vw] font-black tracking-tighter leading-none select-none text-white/40 mix-blend-overlay text-center"
          style={{ 
            fontFamily: 'Impact, Arial Black, sans-serif'
          }}
        >
          {language === 'ar' ? 'نوس وليس دوس' : 'NOOS NOT DOSS'}
        </h1>
      </div>
    </div>
  );
...
export default function Noos() {
  ...
  const content = {
    ar: {
      ...
      suitableDesc: "مثالي لجميع الأعمار ومختلف مستويات المهارة.",
      families: "العائلات",
      everyone: "الجميع",
      ...
      satSun: "السبت - الأحد",
      locations: "المواقع",
      arcadeCenter: "مركز الألعاب",
      address: "بوليفارد رياض سيتي، الرياض، المملكة العربية السعودية",
      getDirections: "احصل على الاتجاهات",
      reminders: "تعليمات هامة",
      reminder1: "استمتع بوقتك واقضِ أجمل الأوقات الترفيهية!",
      reminder2: "تأكد من استلام جوائزك وبطاقتك قبل المغادرة.",
      selectTickets: "اختر التذاكر",
      choosePass: "اختر بطاقة الدخول الخاصة بك واستعد للعب الفوري والترفيه.",
      total: "الإجمالي",
      admit: "حجز دخول",
      admitOne: "دخول فرد",
      ...
      ticketTypes: [
        ...
        },
        {
          ...
          subtitle: "شامل كافة الألعاب والامتيازات الخاصة",
          price: "120",
          validDate: "10/26 • 5 أفراد",
          primaryColor: "#E09502",
        ...
        },
        {
          ...
          subtitle: "دخول عام إلى صالة الألعاب الرئيسية",
          price: "35",
    ...
    en: {
      ...
      suitableDesc: "Perfect for all ages and skill levels.",
      families: "Families",
      everyone: "Everyone",
      ...
      satSun: "Sat - Sun",
      locations: "Locations",
      arcadeCenter: "Arcade Center",
      address: "Boulevard Riyadh City, Riyadh, Saudi Arabia",
      getDirections: "Get Directions",
      reminders: "Reminders",
      reminder1: "Have fun!",
      reminder2: "Collect your prizes before leaving.",
  ...
  return (
    <div className="bg-[#E09502] min-h-screen w-full relative overflow-x-hidden overflow-y-auto scrollbar-hide font-sans flex flex-col selection:bg-white selection:text-[#E09502]">
      {/* Grid Background */}
      ...
      <AnimatePresence>
        {isAdExpanded ? (
          ...
          >
            ...
            <motion.div 
              layoutId="ad-card-container-noos"
            ...
            >
              ...
              <div className="w-full lg:w-[350px] bg-[#161616] p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 shrink-0 md:overflow-y-auto scrollbar-hide relative z-20 text-start">
                <div className="flex items-center gap-4 mb-10">
                   <motion.div layoutId="ad-logo-noos" className="w-16 h-16 rounded-full bg-white flex items-center justify-center overflow-hidden shadow-inner shrink-0 p-2">
                       <img src={NoosIcon} alt="Logo" className="w-full h-full object-contain" />
                   </motion.div>
                   <div>
                     <motion.h2 layoutId="ad-title-noos" className="text-2xl font-bold tracking-tight text-white mb-0.5 font-sans">Noos Game</motion.h2>
                     <p className="text-[#E09502] text-xs font-bold tracking-wider uppercase font-sans">{t.eventDetails}</p>
                   </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                     ...
                     <div className="flex flex-wrap gap-2">
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium font-sans">{t.families}</span>
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium font-sans">{t.everyone}</span>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-2 font-sans">
                        ...
                        <li className="flex justify-between items-center bg-[#E09502]/20 px-3 py-2 rounded-lg border border-[#E09502]/40 text-[#E09502]"><span>{t.satSun}</span> <span className="font-bold font-mono">09:00 - 23:00</span></li>
                     </ul>
                  </div>
                  ...
                  <div>
                     ...
                     <div className="bg-[#1C1C1D] p-4 rounded-xl border border-white/5 font-sans">
                        <h4 className="font-bold text-white mb-1">{t.arcadeCenter}</h4>
                        <p className="text-gray-400 text-xs mb-3 leading-relaxed">{t.address}</p>
                        <button className="text-xs font-bold text-[#E09502] uppercase tracking-wider hover:text-white transition-colors cursor-pointer">{t.getDirections} &rarr;</button>
                     </div>
                  </div>
          ...
          >
             <motion.div 
               ...
               transition={{ type: "spring", bounce: 0.15, duration: 0.5 }}
             >
                <motion.div layoutId="ad-logo-noos" className="w-12 h-12 rounded-full bg-white flex items-center justify-center overflow-hidden shrink-0">
                    <img src={NoosIcon} alt="Noos" className="w-[80%] h-[80%] object-contain" />
                </motion.div>
                
                <div className="flex flex-col justify-center min-w-[140px]">
                    <motion.span layoutId="ad-title-noos" className="text-xs font-bold tracking-wide whitespace-nowrap text-white font-sans">{t.eventDetails}</motion.span>
