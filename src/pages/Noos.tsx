...
import NoosCharacter from "../assets/images/assest/1nooscharater.png";
            ...
            >
              ...
              <div className="w-full lg:w-[320px] bg-[#161616] p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 shrink-0 md:overflow-y-auto scrollbar-hide relative z-20">
                <div className="flex items-center gap-4 mb-10">
                   ...
                   <div>
                     <motion.h2 layoutId="ad-title-noos" className="text-2xl font-bold tracking-tight text-white mb-0.5">Noos Game</motion.h2>
                     <p className="text-[#E09502] text-xs font-bold tracking-wider uppercase">Event Details</p>
                   </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                     ...
                     <p className="text-gray-400 text-sm leading-relaxed mb-3">Perfect for all ages and skill levels.</p>
                     <div className="flex flex-wrap gap-2">
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium">Families</span>
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium">Everyone</span>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-2">
                        ...
                        <li className="flex justify-between items-center bg-[#E09502]/20 px-3 py-2 rounded-lg border border-[#E09502]/40 text-[#E09502]"><span>Sat - Sun</span> <span className="font-bold">09:00 - 23:00</span></li>
                     </ul>
                  </div>
                  ...
                  <div>
                     ...
                     <div className="bg-[#1C1C1D] p-4 rounded-xl border border-white/5">
                        <h4 className="font-bold text-white mb-1">Arcade Center</h4>
                        <p className="text-gray-400 text-xs mb-3">123 Play Way, Fun City, FC 90210</p>
                        <button className="text-xs font-bold text-[#E09502] uppercase tracking-wider hover:text-white transition-colors">Get Directions &rarr;</button>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-3">
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-orange-400"/> Have fun!</li>
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-blue-400"/> Collect your prizes before leaving.</li>
                     </ul>
                  </div>
                </div>
              </div>
          ...
          >
             ...
             >
                ...
                <div className="flex flex-col justify-center min-w-[140px]">
                    <motion.span layoutId="ad-title-noos" className="text-xs font-bold tracking-wide whitespace-nowrap text-white">Event Details</motion.span>
