...
import DossCharacter from "../assets/images/assest/doos_character.png";
            ...
            >
              ...
              <div className="w-full lg:w-[320px] bg-[#161616] p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 shrink-0 md:overflow-y-auto scrollbar-hide relative z-20">
                <div className="flex items-center gap-4 mb-10">
                   ...
                   <div>
                     <motion.h2 layoutId="ad-title-doss" className="text-2xl font-bold tracking-tight text-white mb-0.5">Doss Karting</motion.h2>
                     <p className="text-[#032458] text-xs font-bold tracking-wider uppercase">Event Details</p>
                   </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                     ...
                     <p className="text-gray-400 text-sm leading-relaxed mb-3">Perfect for adrenaline lovers, friends, and family.</p>
                     <div className="flex flex-wrap gap-2">
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium">Teens & Adults</span>
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium">Kids (10+)</span>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-2">
                        ...
                        <li className="flex justify-between items-center bg-[#032458]/40 px-3 py-2 rounded-lg border border-[#032458]/40 text-[#4ca5ff]"><span>Sat - Sun</span> <span className="font-bold">09:00 - 23:00</span></li>
                     </ul>
                  </div>
                  ...
                  <div>
                     ...
                     <div className="bg-[#1C1C1D] p-4 rounded-xl border border-white/5">
                        <h4 className="font-bold text-white mb-1">Main Track</h4>
                        <p className="text-gray-400 text-xs mb-3">123 Speed Way, Fun City, FC 90210</p>
                        <button className="text-xs font-bold text-[#4ca5ff] uppercase tracking-wider hover:text-white transition-colors">Get Directions &rarr;</button>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-3">
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-orange-400"/> Arrive 15 mins before race time.</li>
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-blue-400"/> Closed-toe shoes required.</li>
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-red-400"/> Helmets provided.</li>
                     </ul>
                  </div>
                </div>
              </div>
          ...
          >
             ...
             >
                ...
                <div className="flex flex-col justify-center min-w-[140px]">
                    <motion.span layoutId="ad-title-doss" className="text-xs font-bold tracking-wide whitespace-nowrap text-white">Event Details</motion.span>
