  ...
  return (
    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-[#84cc16]">
      ...
      <div className="absolute inset-0 flex items-center justify-center flex-col pointer-events-none">
        ...
        >
          {language === 'ar' ? 'حروب فيزيا' : 'FIZZIA WARS'}
        </h1>
      </div>
    </div>
  );
...
export default function Fizzia() {
  ...
  const content = {
    ar: {
      ...
      suitableDesc: "مثالي لعشاق حرب الليزر والقتال التكتيكي المثير.",
      teens: "المراهقون",
      adults: "البالغون",
      ...
      reminder1: "ارتدِ ملابس داكنة لتصعب رؤيتك في الساحة.",
      reminder2: "يمنع الجري السريع داخل الساحة حفاظاً على سلامتك.",
      selectTickets: "اختر التذاكر",
      choosePass: "اختر بطاقة الدخول واستعد للمنافسة الحماسية.",
      total: "الإجمالي",
      admit: "حجز دخول",
      admitOne: "دخول فرد",
      ...
      ticketTypes: [
        {
          title: "باقة الفريق",
          subtitle: "دخول لـ 4 لاعبين لخوض المعركة جماعياً",
          price: "85",
          validDate: "10/26 • 4 أفراد",
          primaryColor: "#FFD500",
          secondaryColor: "#2F7CFF",
        },
        {
          title: "باقة كبار الشخصيات VIP",
          subtitle: "ذخيرة غير محدودة + معدات خاصة ومطورة",
          price: "120",
        ...
        },
        {
          ...
          subtitle: "دخول عام إلى ساحة المعركة الرئيسية",
          price: "35",
    ...
    en: {
      ...
      suitableDesc: "Perfect for laser tag and battle lovers.",
      teens: "Teens",
      adults: "Adults",
      ...
      reminders: "Reminders",
      reminder1: "Wear dark colors to hide.",
      reminder2: "No running in the arena.",
            ...
            >
              ...
              <div className="w-full lg:w-[350px] bg-[#161616] p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 shrink-0 md:overflow-y-auto scrollbar-hide relative z-20 text-start">
                <div className="flex items-center gap-4 mb-10">
                   ...
                   <div>
                     <motion.h2 layoutId="ad-title-fizzia" className="text-2xl font-bold tracking-tight text-white mb-0.5 font-sans">Fizzia Wars</motion.h2>
                     <p className="text-[#84cc16] text-xs font-bold tracking-wider uppercase font-sans">{t.eventDetails}</p>
                   </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                     ...
                     <div className="flex flex-wrap gap-2">
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium font-sans">{t.teens}</span>
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium font-sans">{t.adults}</span>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-2 font-sans">
                        ...
                        <li className="flex justify-between items-center bg-[#84cc16]/20 px-3 py-2 rounded-lg border border-[#84cc16]/40 text-[#84cc16]"><span>{t.satSun}</span> <span className="font-bold font-mono">09:00 - 23:00</span></li>
                     </ul>
                  </div>
                  ...
                  <div>
                     ...
                     <div className="bg-[#1C1C1D] p-4 rounded-xl border border-white/5 font-sans">
                        <h4 className="font-bold text-white mb-1">{t.battleArena}</h4>
                        <p className="text-gray-400 text-xs mb-3 leading-relaxed">{t.address}</p>
                        <button className="text-xs font-bold text-[#84cc16] uppercase tracking-wider hover:text-white transition-colors cursor-pointer">{t.getDirections} &rarr;</button>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-3 font-sans">
                        ...
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-red-400"/> {t.reminder2}</li>
                     </ul>
                  </div>
                </div>
              </div>
          ...
          >
             ...
             >
                ...
                <div className="flex flex-col justify-center min-w-[140px]">
                    <motion.span layoutId="ad-title-fizzia" className="text-xs font-bold tracking-wide whitespace-nowrap text-white font-sans">{t.eventDetails}</motion.span>
