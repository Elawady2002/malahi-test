...
import LambyCharacter from "../assets/images/assest/lamby_character.png";
  ...
  return (
    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-[#FF659B]">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h1 
          className="text-[30vw] font-black tracking-tighter leading-none select-none text-white/40 mix-blend-overlay"
          style={{ 
      ...
      <main className="relative z-30 w-full flex items-center justify-center -mt-10 overflow-visible min-h-screen">
          <div className="w-full h-full min-h-[600px] flex items-center justify-center relative overflow-visible">
            <ProgressiveSmearCarousel 
              ...
              gap={isMobile ? 40 : 80}
              maxRotation={45} // Higher rotation for the 3D 'album/vinyl' look
              perspective={1200}
              borderRadius={4} // Sharper corners for a vinyl/album cover feel
              scrollDamping={15}
              edgeColor="#000000"
              edgeWidth={0}
            />
            ...
            >
              ...
              <div className="w-full lg:w-[320px] bg-[#161616] p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 shrink-0 md:overflow-y-auto scrollbar-hide relative z-20">
                <div className="flex items-center gap-4 mb-10">
                   ...
                   <div>
                     <motion.h2 layoutId="ad-title" className="text-2xl font-bold tracking-tight text-white mb-0.5">LambyMania</motion.h2>
                     <p className="text-[#FF659B] text-xs font-bold tracking-wider uppercase">Event Details</p>
                   </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                     ...
                     <p className="text-gray-400 text-sm leading-relaxed mb-3">Perfect for families, children ages 3-12, and anyone who loves interactive entertainment.</p>
                     <div className="flex flex-wrap gap-2">
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium">Kids & Toddlers</span>
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium">Parents</span>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-2">
                        ...
                        <li className="flex justify-between items-center bg-[#FF659B]/10 px-3 py-2 rounded-lg border border-[#FF659B]/20 text-[#FF659B]"><span>Sat - Sun</span> <span className="font-bold">09:00 - 23:00</span></li>
                     </ul>
                  </div>
                  ...
                  <div>
                     ...
                     <div className="bg-[#1C1C1D] p-4 rounded-xl border border-white/5">
                        <h4 className="font-bold text-white mb-1">Main Center</h4>
                        <p className="text-gray-400 text-xs mb-3">123 Lamby Boulevard, Fun City, FC 90210</p>
                        <button className="text-xs font-bold text-[#FF659B] uppercase tracking-wider hover:text-white transition-colors">Get Directions &rarr;</button>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-3">
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-orange-400"/> Arrive 15 mins before showtime.</li>
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-blue-400"/> Socks required in soft-play areas.</li>
                        <li className="flex gap-3 items-start"><AlertCircle size={16} className="shrink-0 mt-0.5 text-red-400"/> No outside food permitted.</li>
                     </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 bg-[#0a0a0a] p-6 lg:p-8 md:overflow-y-auto scrollbar-hide relative z-10 flex flex-col">
                 <div className="mb-8 shrink-0">
                    ...
                    <p className="text-sm text-gray-400">Choose your colorful entry pass.</p>
                 </div>
                      ...
                      },
                      {
                       ...
                       <div key={idx} className="w-full shrink-0 flex drop-shadow-[0_15px_30px_rgba(0,0,0,0.4)] group cursor-pointer hover:rotate-1 hover:-translate-y-1 transition-all duration-300">
                         ...
                         <div className="flex-1 relative p-6 flex flex-col justify-between overflow-hidden rounded-l-md" style={{ backgroundColor: t.primaryColor }}>
                            ...
                            {/* Optional background graphics per ticket */}
          ...
          >
             ...
             >
                ...
                <div className="flex flex-col justify-center min-w-[140px]">
                    <motion.span layoutId="ad-title" className="text-xs font-bold tracking-wide whitespace-nowrap text-white">Event Details</motion.span>
