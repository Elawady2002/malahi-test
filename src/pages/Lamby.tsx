...
function GridBackground({ language }: { language: string }) {
  return (
    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-[#FF659B]">
      {/* Pink grid pattern */}
      <div 
...
export default function Lamby() {
  ...
  const content = {
    ar: {
      ...
      suitableDesc: "مثالي للعائلات، الأطفال من سن 3 إلى 12 سنة، ولكل من يعشق الألعاب التفاعلية الحية والممتعة.",
      kidsToddlers: "أطفال ورضع",
      parents: "الوالدين",
      ...
      satSun: "السبت - الأحد",
      locations: "المواقع",
      mainCenter: "الفرع الرئيسي",
      address: "بوليفارد رياض سيتي، الرياض، المملكة العربية السعودية",
      getDirections: "احصل على الاتجاهات",
      reminders: "تعليمات هامة",
      reminder1: "يرجى الحضور قبل 15 دقيقة من موعد الحجز.",
      reminder2: "يلزم ارتداء الجوارب في منطقة اللعب الناعمة.",
      reminder3: "غير مسموح بإدخال المأكولات والمشروبات الخارجية.",
      selectTickets: "اختر التذاكر",
      choosePass: "اختر بطاقة الدخول الملونة الخاصة بك واستمتع بالمغامرة.",
      total: "الإجمالي",
      admit: "حجز دخول",
      admitOne: "دخول فرد",
      ...
      ticketTypes: [
        ...
        },
        {
          ...
          subtitle: "دخول سريع، وصول خلف الكواليس ومأكولات",
          price: "120",
          validDate: "10/26 • 5 أفراد",
          primaryColor: "#FF659B",
        ...
        },
        {
          ...
          subtitle: "دخول عام لكافة مناطق الألعاب",
          price: "35",
    ...
    en: {
      ...
      suitableDesc: "Perfect for families, children ages 3-12, and anyone who loves interactive entertainment.",
      kidsToddlers: "Kids & Toddlers",
      parents: "Parents",
      ...
      address: "Boulevard Riyadh City, Riyadh, Saudi Arabia",
      getDirections: "Get Directions",
      reminders: "Reminders",
      reminder1: "Arrive 15 mins before showtime.",
      reminder2: "Socks required in soft-play areas.",
      reminder3: "No outside food permitted.",
      selectTickets: "Select Tickets",
      choosePass: "Choose your colorful entry pass.",
      total: "Total",
      admit: "ADMIT",
      admitOne: "Admit 1",
      ...
      ticketTypes: [
        ...
        {
          title: "VIP Premium",
          subtitle: "PRIORITY, BACKSTAGE & FOOD",
          price: "120",
          validDate: "10/26 • 5 PAX",
          primaryColor: "#FF659B",
          secondaryColor: "#FF4500",
  ...
  return (
    <div className="bg-[#FF659B] min-h-screen w-full relative overflow-x-hidden overflow-y-auto scrollbar-hide font-sans flex flex-col selection:bg-white selection:text-[#FF659B]">
      {/* Grid Background */}
        ...
        {isAdExpanded ? (
            ...
            >
              ...
              <div className="w-full lg:w-[350px] bg-[#161616] p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 shrink-0 md:overflow-y-auto scrollbar-hide relative z-20 text-start">
                <div className="flex items-center gap-4 mb-10">
                   <motion.div layoutId="ad-logo" className="w-16 h-16 rounded-full bg-white flex items-center justify-center overflow-hidden shadow-inner shrink-0 p-2">
                       <img src={LambyIcon} alt="Logo" className="w-full h-full object-contain" />
                   </motion.div>
                   <div>
                     <motion.h2 layoutId="ad-title" className="text-2xl font-bold tracking-tight text-white mb-0.5 font-sans">LambyMania</motion.h2>
                     <p className="text-[#FF659B] text-xs font-bold tracking-wider uppercase font-sans">{t.eventDetails}</p>
                   </div>
                </div>
                ...
                <div className="space-y-8">
                  <div>
                     ...
                     <div className="flex flex-wrap gap-2">
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium font-sans">{t.kidsToddlers}</span>
                       <span className="text-[11px] px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-gray-300 font-medium font-sans">{t.parents}</span>
                     </div>
                  </div>
                  ...
                  <div>
                     ...
                     <ul className="text-sm text-gray-400 space-y-2 font-sans">
                        ...
                        <li className="flex justify-between items-center bg-[#FF659B]/10 px-3 py-2 rounded-lg border border-[#FF659B]/20 text-[#FF659B]"><span>{t.satSun}</span> <span className="font-bold font-mono">09:00 - 23:00</span></li>
                     </ul>
                  </div>
                  ...
                  <div>
                     ...
                     <div className="bg-[#1C1C1D] p-4 rounded-xl border border-white/5 font-sans">
                        <h4 className="font-bold text-white mb-1">{t.mainCenter}</h4>
                        <p className="text-gray-400 text-xs mb-3 leading-relaxed">{t.address}</p>
                        <button className="text-xs font-bold text-[#FF659B] uppercase tracking-wider hover:text-white transition-colors cursor-pointer">{t.getDirections} &rarr;</button>
                     </div>
                  </div>
              ...
              {/* Pane 3: Tickets */}
              <div className="flex-1 bg-[#0a0a0a] p-6 lg:p-8 md:overflow-y-auto scrollbar-hide relative z-10 flex flex-col text-start">
                       ...
                       <div key={idx} className="w-full shrink-0 flex drop-shadow-[0_15px_30px_rgba(0,0,0,0.4)] group cursor-pointer hover:rotate-1 hover:-translate-y-1 transition-all duration-300">
                          ...
                          <div className="flex-1 relative p-6 flex flex-col justify-between overflow-hidden rounded-l-md" style={{ backgroundColor: ticket.primaryColor }}>
                             ...
                             <div className="absolute right-[-20px] bottom-[-20px] opacity-20 pointer-events-none">
                                {idx === 0 && <svg width="150" height="150" viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" stroke="#111" strokeWidth="15" fill="none"/></svg>}
                                {idx === 1 && <svg width="150" height="150" viewBox="0 0 100 100"><path d="M50 10 L90 90 L10 90 Z" stroke="#111" strokeWidth="15" fill="none"/></svg>}
                                {idx === 2 && <svg width="150" height="150" viewBox="0 0 100 100"><rect x="20" y="20" width="60" height="60" stroke="#111" strokeWidth="15" fill="none" transform="rotate(45 50 50)"/></svg>}
                             </div>
                          </div>
          ...
          >
              <motion.div 
                ...
                transition={{ type: "spring", bounce: 0.15, duration: 0.5 }}
              >
                 <motion.div layoutId="ad-logo" className="w-12 h-12 rounded-full bg-white flex items-center justify-center overflow-hidden shrink-0">
                     <img src={LambyIcon} alt="Lamby" className="w-[80%] h-[80%] object-contain" />
                 </motion.div>
                 
                 <div className="flex flex-col justify-center min-w-[140px]">
                     <motion.span layoutId="ad-title" className="text-xs font-bold tracking-wide whitespace-nowrap text-white font-sans">{t.eventDetails}</motion.span>
